...
class AddIngredientsListDatabase(private var ingredientsListBox: Box<IngredientsList>?) {
    ...
    private fun addIngredientsList() {
        ...
        if (ingredientsListBox?.isEmpty == true) {
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 19, ingredientsId = 10, ingredientsName = "de crème fraiche", ingredientsReplacementId = null, quantity = 100.0, unit = "g", recipeMirror = null))
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 19, ingredientsId = 13, ingredientsName = "d'emmental râpé ou parmesan râpé ou gruyère râpé", ingredientsReplacementId = 353, quantity = 200.0, unit = "g", recipeMirror = null))
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 19, ingredientsId = 1, ingredientsName = "de beurre", ingredientsReplacementId = null, quantity = 115.0, unit = "g", recipeMirror = null))
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 20, ingredientsId = 35, ingredientsName = "de roquefort", ingredientsReplacementId = null, quantity = 225.0, unit = "g", recipeMirror = null))
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 21, ingredientsId = 11, ingredientsName = "de crème fraiche liquide", ingredientsReplacementId = null, quantity = 20.0, unit = "cl", recipeMirror = null))
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 22, ingredientsId = 27, ingredientsName = "mozzarellas", ingredientsReplacementId = null, quantity = 3.0, unit = null, recipeMirror = null))
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 24, ingredientsId = 10, ingredientsName = "de crème fraiche épaisse", ingredientsReplacementId = null, quantity = 200.0, unit = "g", recipeMirror = null))
            ingredientsListBox?.put(IngredientsList(recipeId = 24, ingredientsId = 30, ingredientsName = "de parmesan râpé", ingredientsReplacementId = null, quantity = 100.0, unit = "g", recipeMirror = null))
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 25, ingredientsId = 30, ingredientsName = "de copeaux de parmesan", ingredientsReplacementId = null, quantity = 50.0, unit = "g", recipeMirror = null))
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 27, ingredientsId = 21, ingredientsName = "de gruyère allégé râpé", ingredientsReplacementId = null, quantity = 80.0, unit = "g", recipeMirror = null))
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 32, ingredientsId = 79, ingredientsName = "de feuilles de coriandre hachées", ingredientsReplacementId = null, quantity = 3.0, unit = "cuillères à soupe", recipeMirror = null))
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 32, ingredientsId = 192, ingredientsName = "de curcuma", ingredientsReplacementId = null, quantity = 0.0, unit = "cuillère à café", recipeMirror = null))
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 34, ingredientsId = 10, ingredientsName = "de crème fraiche semi-épaisse", ingredientsReplacementId = null, quantity = 20.0, unit = "cl", recipeMirror = null))
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 35, ingredientsId = 13, ingredientsName = "d'emmental râpé", ingredientsReplacementId = null, quantity = 200.0, unit = "g", recipeMirror = null))
            ...
            ingredientsListBox?.put(IngredientsList(recipeId = 36, ingredientsId = 13, ingredientsName = "d'emmental râpé", ingredientsReplacementId = null, quantity = 200.0, unit = "g", recipeMirror = null))
