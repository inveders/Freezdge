...
open class DetailRecipeItem: AbstractItem<DetailRecipeItem.ViewHolder>() {
    ...
    class ViewHolder(val view: View) : FastAdapter.ViewHolder<DetailRecipeItem>(view) {
        ...
        var recipeNumberPerson: TextView = view.findViewById(R.id.activity_recipe_detail_number_person_image_text)
        var recipeKcal: TextView = view.findViewById(R.id.activity_recipe_detail_kcal_image_text)
        var recipeDetailPhoto : ImageView= view.findViewById(R.id.activity_recipe_detail_photo)
        var recipeTotalTime : TextView= view.findViewById(R.id.activity_recipe_total_time)
        var recipePrepCookTime: TextView = view.findViewById(R.id.activity_recipe_detail_time_image_text)
